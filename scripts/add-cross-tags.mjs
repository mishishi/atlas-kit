...
const CROSS_TAGS = {
  ...
  // R57 (2026-06-26): 10 new cards to reach 400
  "maine-coon": ["哺乳", "全球", "家庭", "长毛"],
  "peregrine-falcon": ["鸟类", "全球", "猛禽", "速度"],
  "day-of-the-dead": ["节日", "墨西哥", "文化", "亡灵"],
  "ramen": ["食物", "日本", "东亚", "饮食"],
  "marrakech": ["城市", "北非", "摩洛哥", "色彩"],
  "cowboy-bebop": ["动漫", "日本", "90年代", "科幻"],
  "radiohead": ["音乐", "英国", "90年代", "另类摇滚"],
  "marco-polo": ["人物", "欧洲", "古代", "中世纪", "旅行"],
  "matcha": ["植物", "东亚", "日本", "饮食", "文化"],
  "sahara-desert": ["自然", "非洲", "全球", "气候"],
};
